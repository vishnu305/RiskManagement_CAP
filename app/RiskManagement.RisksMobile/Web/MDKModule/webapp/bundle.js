...
let risksmobile_actions_riskmanagementservice_risks_navtorisks_createmitigations_action = __webpack_require__(/*! ./RisksMobile/Actions/RiskManagementService/Risks/NavToRisks_CreateMitigations.action */ "./build.definitions/RisksMobile/Actions/RiskManagementService/Risks/NavToRisks_CreateMitigations.action")
...
let risksmobile_actions_riskmanagementservice_risks_risks_createmitigations_action = __webpack_require__(/*! ./RisksMobile/Actions/RiskManagementService/Risks/Risks_CreateMitigations.action */ "./build.definitions/RisksMobile/Actions/RiskManagementService/Risks/Risks_CreateMitigations.action")
...
let risksmobile_actions_riskmanagementservice_risks_risks_detailpopover_action = __webpack_require__(/*! ./RisksMobile/Actions/RiskManagementService/Risks/Risks_DetailPopover.action */ "./build.definitions/RisksMobile/Actions/RiskManagementService/Risks/Risks_DetailPopover.action")
...
let risksmobile_pages_riskmanagementservice_risks_risks_createmitigations_page = __webpack_require__(/*! ./RisksMobile/Pages/RiskManagementService_Risks/Risks_CreateMitigations.page */ "./build.definitions/RisksMobile/Pages/RiskManagementService_Risks/Risks_CreateMitigations.page")
...
let risksmobile_rules_riskmanagementservice_risks_navtorisks_createmitigations_js = __webpack_require__(/*! ./RisksMobile/Rules/RiskManagementService/Risks/NavToRisks_CreateMitigations.js */ "./build.definitions/RisksMobile/Rules/RiskManagementService/Risks/NavToRisks_CreateMitigations.js")
...
let risksmobile_rules_riskmanagementservice_risks_risks_createmitigations_js = __webpack_require__(/*! ./RisksMobile/Rules/RiskManagementService/Risks/Risks_CreateMitigations.js */ "./build.definitions/RisksMobile/Rules/RiskManagementService/Risks/Risks_CreateMitigations.js")
...
module.exports = {
	...
	risksmobile_actions_riskmanagementservice_risks_navtorisks_createmitigations_action : risksmobile_actions_riskmanagementservice_risks_navtorisks_createmitigations_action,
	...
	risksmobile_actions_riskmanagementservice_risks_risks_createmitigations_action : risksmobile_actions_riskmanagementservice_risks_risks_createmitigations_action,
	...
	risksmobile_actions_riskmanagementservice_risks_risks_detailpopover_action : risksmobile_actions_riskmanagementservice_risks_risks_detailpopover_action,
	...
	risksmobile_pages_riskmanagementservice_risks_risks_createmitigations_page : risksmobile_pages_riskmanagementservice_risks_risks_createmitigations_page,
	...
	risksmobile_rules_riskmanagementservice_risks_navtorisks_createmitigations_js : risksmobile_rules_riskmanagementservice_risks_navtorisks_createmitigations_js,
	...
	risksmobile_rules_riskmanagementservice_risks_risks_createmitigations_js : risksmobile_rules_riskmanagementservice_risks_risks_createmitigations_js,
...
/***/ "./build.definitions/RisksMobile/Rules/RiskManagementService/Risks/NavToRisks_CreateMitigations.js":
/*!*********************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/RiskManagementService/Risks/NavToRisks_CreateMitigations.js ***!
  \*********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RisksMobile/Rules/RiskManagementService/Risks/Risks_CreateMitigations.js":
/*!****************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/RiskManagementService/Risks/Risks_CreateMitigations.js ***!
  \****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RisksMobile/Pages/RiskManagementService_Risks/Risks_CreateMitigations.page":
/*!******************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Pages/RiskManagementService_Risks/Risks_CreateMitigations.page ***!
  \******************************************************************************************************/
/***/ ((module) => {

module.exports = {"ActionBar":{"Items":[{"OnPress":"/RisksMobile/Actions/CloseModalPage_Cancel.action","Position":"Left","SystemItem":"Cancel","_Type":"Control.Type.ActionBarItem"},{"OnPress":"/RisksMobile/Rules/RiskManagementService/Risks/Risks_CreateMitigations.js","Position":"Right","SystemItem":"Save","_Type":"Control.Type.ActionBarItem"}],"Caption":"$(L,Create_Mitigations)","_Type":"Control.Type.ActionBar"},"Controls":[{"Sections":[{"_Type":"Section.Type.FormCell","_Name":"SectionFormCell0","Visible":true,"Controls":[{"Caption":"createdAt","_Name":"createdAt","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"createdBy","_Name":"createdBy","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"description","_Name":"description","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"owner","_Name":"owner","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"timeline","_Name":"timeline","_Type":"Control.Type.FormCell.SimpleProperty"}]}],"_Name":"SectionedTable0","_Type":"Control.Type.SectionedTable"}],"_Type":"Page","_Name":"Risks_CreateMitigations"}
...
/***/ "./build.definitions/RisksMobile/Actions/RiskManagementService/Risks/NavToRisks_CreateMitigations.action":
/*!***************************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RiskManagementService/Risks/NavToRisks_CreateMitigations.action ***!
  \***************************************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RisksMobile/Pages/RiskManagementService_Risks/Risks_CreateMitigations.page","_Type":"Action.Type.Navigation"}
...
/***/ "./build.definitions/RisksMobile/Actions/RiskManagementService/Risks/Risks_CreateMitigations.action":
/*!**********************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RiskManagementService/Risks/Risks_CreateMitigations.action ***!
  \**********************************************************************************************************/
/***/ ((module) => {

module.exports = {"ParentLink":{"Property":"risks","Target":{"EntitySet":"Risks","ReadLink":"{@odata.readLink}"}},"OnFailure":"/RisksMobile/Actions/CreateEntityFailureMessage.action","OnSuccess":"/RisksMobile/Actions/CreateEntitySuccessMessage.action","Properties":{"createdAt":"#Page:Risks_CreateMitigations/#Control:createdAt/#Value","createdBy":"#Page:Risks_CreateMitigations/#Control:createdBy/#Value","description":"#Page:Risks_CreateMitigations/#Control:description/#Value","owner":"#Page:Risks_CreateMitigations/#Control:owner/#Value","timeline":"#Page:Risks_CreateMitigations/#Control:timeline/#Value"},"Target":{"EntitySet":"Mitigations","Service":"/RisksMobile/Services/RiskManagementService.service"},"ActionResult":{"_Name":"create"},"_Type":"Action.Type.ODataService.CreateRelatedEntity"}
...
/***/ "./build.definitions/RisksMobile/Actions/RiskManagementService/Risks/Risks_DetailPopover.action":
/*!******************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RiskManagementService/Risks/Risks_DetailPopover.action ***!
  \******************************************************************************************************/
/***/ ((module) => {

module.exports = {"PopoverItems":[{"Title":"Add Mitigations","OnPress":"/RisksMobile/Rules/RiskManagementService/Risks/NavToRisks_CreateMitigations.js"},{"Title":"Delete","OnPress":"/RisksMobile/Rules/RiskManagementService/Risks/Risks_DeleteConfirmation.js"}],"_Type":"Action.Type.PopoverMenu"}
